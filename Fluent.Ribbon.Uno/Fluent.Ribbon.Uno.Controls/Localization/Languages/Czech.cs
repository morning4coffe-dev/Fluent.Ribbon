...
public class Czech : RibbonLocalizationBase
{
    ...
    public override string DisplayOptionsButtonScreenTipText { get; } = "Nastavení zobrazování pásu karet";
    public override string DisplayOptionsButtonScreenTipTitle { get; } = "Nastavení pásu karet";
    public override string ExpandRibbon { get; } = "Zobrazit pás karet";
    public override string MinimizeRibbon { get; } = "Skrýt pás karet";
    ...
    public override string RibbonLayout { get; } = "Možnosti pásu karet";
    ...
    public override string ShowRibbon { get; } = "Zobrazení pásu karet";
